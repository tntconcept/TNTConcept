...
#
MY_LDAP_DEFAULTPWDPOLICYDN="cn=default,ou=Policies,dc=autentia,dc=com"

#
# LDAP search base for users
# eg: ou=People,dc=example,dc=com
#
MY_LDAP_SEARCHBASE="ou=People,dc=autentia,dc=com"
...
#   %login : user login
#
MY_MAIL_BODY="Hola %name,\n\nTu contraseña caduca pronto. Por favor, modifica tu contraseña de LDAP."

#
# Mail subject
#
MY_MAIL_SUBJECT="Tu contraseña de LDAP caduca pronto."
