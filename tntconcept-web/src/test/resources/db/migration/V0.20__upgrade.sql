...
CREATE INDEX ndx_periodicalAccountEntry_organizationId on PeriodicalAccountEntry (organizationId);
ALTER TABLE PeriodicalAccountEntry
 ADD CONSTRAINT FK_periodicalaccountentry_organizationId FOREIGN KEY (organizationId)
