...
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci COMMENT='contactos de las Organizationes';
...
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci COMMENT='Ofertas';
...
) ENGINE=InnoDB AUTO_INCREMENT=16 DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci COMMENT='los clientes';
...
) ENGINE=InnoDB AUTO_INCREMENT=18 DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci COMMENT='Projects';
...
INSERT INTO `user` (`id`,`login`,`password`,`roleId`,`active`,`name`,`nif`,`birthDate`,`academicQualification`,`phone`,`mobile`,`street`,`city`,`postalCode`,`provinceId`,`married`,`childrenNumber`,`drivenLicenseType`,`vehicleType`,`licensePlate`,`startDate`,`categoryId`,`socialSecurityNumber`,`bank`,`account`,`travelAvailability`,`workingInClient`,`email`,`genre`,`salary`,`salaryExtras`,`documentCategoryId`,`securityCard`,`healthInsurance`,`notes`,`photo`,`endTestPeriodDate`,`endContractDate`,`departmentId`,`contractTypeId`,`contractObservations`,`insertDate`,`updateDate`,`dayDuration`,`agreementId`,`agreementYearDuration`) VALUES 
 (1,'admin','dd94709528bb1c83d08f3088d4043f4742891f4f',1,1,'Administrador',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,0,0,NULL,NULL,NULL,'2009-04-02',1,NULL,NULL,NULL,NULL,0,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,1,NULL,NULL,NULL,NULL,480,1,NULL),
