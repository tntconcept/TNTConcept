...
<%@page import="com.autentia.tnt.util.ConfigurationUtil"%>
<%-- Common things to include in document's HEAD part --%>

<script src="<%=request.getContextPath()%>/script/common.jsp" language="Javascript" type="text/javascript" charset="UTF-8"></script>
...
<link rel="stylesheet" href="<%=request.getContextPath()%>/css/dynamicStyles.jsp" type="text/css">
