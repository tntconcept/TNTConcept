...
<i:location place="contactChanges" msg="${msg}" />

<f:view>
	<%@include file="/inc/header.jsp"%>
	<h:form id="contactChanges" enctype="multipart/form-data">
		...
		<t:dataTable id="list" var="change" binding="#{contactBean.changesDataTable}"
			value="#{contactBean.history}"
			...
			<h:column>
				<f:facet name="header">
					<f:verbatim>${msg['positionChanges.user']}</f:verbatim>
				</f:facet>
			...
			<h:column>
				<f:facet name="header">
					<f:verbatim>${msg['positionChanges.field']}</f:verbatim>
				</f:facet>
			...
			<h:column>
				<f:facet name="header">
					<f:verbatim>${msg['positionChanges.oldValue']}</f:verbatim>
				</f:facet>
				<h:outputText value="#{contactBean.changeOldValue}"/>
			</h:column>

			<h:column>
				<f:facet name="header">
					<f:verbatim>${msg['positionChanges.newValue']}</f:verbatim>
				</f:facet>
				<h:outputText value="#{contactBean.changeNewValue}"/>
			</h:column>

			<h:column>
				<f:facet name="header">
					<f:verbatim>${msg['positionChanges.insertDate']}</f:verbatim>
				</f:facet>
