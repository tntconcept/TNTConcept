...
<t:dataTable id="costs" var="item" value="#{projectBean.costs}" preserveDataModel="false" 
    ...
    <h:column>
      ...
      <f:facet name="header">
        <h:outputText value="#{msg['projectCost.name']}" styleClass="detailListHeader"/>
      </f:facet>
      ...
      <f:facet name="header">
        <h:outputText value="#{msg['projectCost.cost']}" styleClass="detailListHeader"/>
      </f:facet>
      ...
      <f:facet name="header">
        <h:outputText value="#{msg['projectCost.billable']}" styleClass="detailListHeader"/>
      </f:facet>
