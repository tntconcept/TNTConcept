...
public class RequestHolidayBean extends BaseBean{
    ...
    public String detail(){
        ...
        return SpringUtils.isAclPermissionGranted(requestHoliday, BasePermission.WRITE) ? NavigationResults.EDIT
    ...
    protected void sendEmail(){
        ...
        final Collection<String> mailSendToHolidayApprovers = ConfigurationUtil.getDefault()
                .getMailSendToHolidayApprovers();
        ...
        for(String sendTo : mailSendToHolidayApprovers){
            ...
            String messageBody = ("<div>Usuario: ").concat("<b>" + name + "</b>").concat(newLine)
                    .concat("Fecha de inicio: ").concat("<b>" + beginDate + "</b>").concat(newLine)
                    .concat("Fecha de fin: ").concat("<b>" + finalDate + "</b>").concat(newLine).concat("Comentarios: ")
                    .concat(this.requestHoliday.getUserComment()).concat(newLine);
    ...
    private boolean validateHasEnoughAvailableFreeHoliday(){
        ...
        int requestedDays = UserHolidaysStateManager.getDefault()
                .getWorkingDays(this.getBeginDate(), this.getFinalDate());
    ...
    /**
     * Método que se ejecuta antes de Save() y que cada implementación podrá sobre
     * escribir con funcionalidad adicional.
     *
     * @param result
     * @return
     */
    ...
    public String doBeforeSave(){
        ...
        if(!this.validateHasEnoughAvailableFreeHoliday()){
