...
public class UserBean extends BaseBean {
	...
	private static final AuthenticationManager		authManager			= AuthenticationManager
																				.getDefault();
	...
	public boolean isUseAgreementYearDuration() {
		return (useAgreementYearDuration != null) ? useAgreementYearDuration : (user.getAgreementYearDuration() == null );
	}
	...
	public List<SelectItem> getCategorys() {
		List<UserCategory> refs = UserCategoryManager.getDefault().getAllEntities(null,
	...
	public List<SelectItem> getDepartments() {
		List<Department> refs = DepartmentManager.getDefault().getAllEntities(null,
				new SortCriteria("name"));
	...
	public List<SelectItem> getContractTypes() {
		List<ContractType> refs = ContractTypeManager.getDefault().getAllEntities(null,
				new SortCriteria("name"));
	...
	public boolean isDeleteAvailable() {
		return (user.getId() != null)
				&& SpringUtils.isAclPermissionGranted(user, BasePermission.DELETE);
	}
