...
import com.autentia.tnt.manager.account.AccountTypeManager;
...
/* account - generated by stajanov (do not edit/delete) */
 ...
 /** Active search object */
  private AccountSearch search = new AccountSearch();

  /** Manager */
  private static AccountManager manager = AccountManager.getDefault();
  
  /** Upload service */
  private static final Uploader uploader = UploaderFactory.getInstance("account");
  ...
  /**
   * List accounts. Order depends on Faces parameter sort.
  ...
  public List<SelectItem> getTypes(){  
    List<AccountType> refs = AccountTypeManager.getDefault().getAllEntities( null, new SortCriteria("name") );
	  
    ArrayList<SelectItem> ret = new ArrayList<SelectItem>();  
    for( AccountType ref : refs ){
  ...
  {
    return SpringUtils.isRolePermissionGranted(Permission.Entity_Create(Account.class));
  }
  ...
  {
    return SpringUtils.isAclPermissionGranted(account,BasePermission.WRITE);
  }
  ...
  public boolean isDeleteAvailable()
  {
    return (account.getId()!=null) &&
	   SpringUtils.isAclPermissionGranted(account,BasePermission.DELETE);
  }
  ...
  public String detail(){
    ...
    account = manager.getEntityById(id);
  ...
  public String save(){
      ...
      if( account.getId()==null ){
        manager.insertEntity(account);
      } else {
        manager.updateEntity(account);
      }
  ...
  public AccountSearch getSearch(){
    ...
    public AccountType getSearchType(){
        return search.getType();
    }
    public void setSearchType( AccountType val ){
        if( search.isTypeSet() ) {
          search.setType( val );
        }
    }
    ...
    {
      if( letter!=null ){
      	UIComponent comp = FacesUtils.getComponent("accounts:list");
  ...
  // Getters and setters to manipulate active Account object
