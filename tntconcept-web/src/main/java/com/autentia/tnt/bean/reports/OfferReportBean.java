...
public class OfferReportBean extends BaseBean {
	...
	public void setSelectedReport(String selectedReport) {
		...
		int numReports = 0;
		numReports = ReportManager.getReportManager().getReportListOffer().size();
		for(int i=0;i<numReports;i++) {
			List reportData = new ArrayList<List>();
			String reportName = "";
			reportData = ReportManager.getReportManager().getReportListOffer().get(i);
