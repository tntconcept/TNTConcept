...
public class ProjectReportBean extends BaseBean {
	...
	public void setSelectedReport(String selectedReport) {
		...
		int numReports = 0;
		numReports = ReportManager.getReportManager().getReportListProject().size();
		for(int i=0;i<numReports;i++) {
			List reportData = new ArrayList<List>();
			String reportName = "";
			reportData = ReportManager.getReportManager().getReportListProject().get(i);
