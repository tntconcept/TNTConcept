...
/**
 * Class to search for AdminHoliday objects
 * @author stajanov code generator
 */
public class AdminHolidaySearch extends SearchCriteria 
{
/* generated by stajanov (do not edit/delete) */
  ...
  public boolean isSearchActive() {
    return customIsSearchActive()||startBeginDateSet||endBeginDateSet||startFinalDateSet||endFinalDateSet||stateSet||observationsSet||userCommentSet||startChargeYearSet||endChargeYearSet||departmentIdSet||startInsertDateSet||endInsertDateSet||startUpdateDateSet||endUpdateDateSet||userRequestSet;
  }
