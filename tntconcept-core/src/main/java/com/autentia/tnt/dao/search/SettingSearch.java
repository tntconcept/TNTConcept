 ...
 */
public class SettingSearch extends SearchCriteria {
	...
	public String getHQL() {
		...
		if (isValueSet()) {
			ret.append((ret.length() == 0) ? "WHERE " : " AND ");
			if (getValue() == null) {
				ret.append("value is NULL");
			} else {
				ret.append("value like :arg" + (iArgNum++));
			}
		}
	...
	public boolean isSearchActive() {
		return customIsSearchActive() || nameSet || valueSet || typeSet
