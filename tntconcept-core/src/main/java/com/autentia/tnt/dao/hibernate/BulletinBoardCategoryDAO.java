...
public class BulletinBoardCategoryDAO extends HibernateManagerBase<BulletinBoardCategory> 
{
  ...
  public BulletinBoardCategory getPublicCategory() {
    return super.loadByPk( BulletinBoardCategory.class, ConfigurationUtil.getDefault().getIdPublicCategory() );
  }
...
/* bulletinBoardCategory - generated by stajanov (do not edit/delete) */
 ...
 /** 
   ...
   */
  public BulletinBoardCategory loadById(int id ) throws DataAccException {
    return super.loadByPk(BulletinBoardCategory.class,id);
  }
