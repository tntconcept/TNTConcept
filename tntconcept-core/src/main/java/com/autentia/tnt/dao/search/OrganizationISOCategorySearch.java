...
/**
 * Class to search for OrganizationISOCategory objects
 * @author stajanov code generator
 */
public class OrganizationISOCategorySearch extends SearchCriteria 
{
/* generated by stajanov (do not edit/delete) */
  ...
  public String toString() {
    StringBuilder ret = new StringBuilder();
    ret.append("OrganizationISOCategorySearch{");
